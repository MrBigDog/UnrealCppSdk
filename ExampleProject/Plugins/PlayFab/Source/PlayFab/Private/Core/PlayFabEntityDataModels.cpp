...
void PlayFab::EntityModels::writeCloudScriptRevisionOptionEnumJSON(CloudScriptRevisionOption enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
EntityModels::CloudScriptRevisionOption PlayFab::EntityModels::readCloudScriptRevisionOptionFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readCloudScriptRevisionOptionFromValue(value.IsValid() ? value->AsString() : "");
}

EntityModels::CloudScriptRevisionOption PlayFab::EntityModels::readCloudScriptRevisionOptionFromValue(const FString& value)
{
...
PlayFab::EntityModels::FScriptExecutionError::~FScriptExecutionError()
{

}

void PlayFab::EntityModels::FScriptExecutionError::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::EntityModels::FScriptExecutionError::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::EntityModels::FLogStatement::~FLogStatement()
{

}

void PlayFab::EntityModels::FLogStatement::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::EntityModels::FLogStatement::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::EntityModels::FExecuteCloudScriptResult::~FExecuteCloudScriptResult()
{
    //if (Error != nullptr) delete Error;

}

void PlayFab::EntityModels::FExecuteCloudScriptResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::EntityModels::FExecuteCloudScriptResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::EntityModels::FExecuteEntityCloudScriptRequest::~FExecuteEntityCloudScriptRequest()
{
    //if (Entity != nullptr) delete Entity;

}

void PlayFab::EntityModels::FExecuteEntityCloudScriptRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::EntityModels::FExecuteEntityCloudScriptRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
