...
namespace PlayFab
{
    ...
    public:
        ...
        DECLARE_DELEGATE_OneParam(FExecuteEntityCloudScriptDelegate, const EntityModels::FExecuteCloudScriptResult&);
         ...
         */
        bool ExecuteEntityCloudScript(EntityModels::FExecuteEntityCloudScriptRequest& request, const FExecuteEntityCloudScriptDelegate& SuccessDelegate = FExecuteEntityCloudScriptDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
