...
namespace PlayFab
{
    ...
    struct PLAYFABCORE_API FPlayFabBaseModel
    {
    ...
    struct PLAYFABCORE_API FJsonKeeper : public FPlayFabBaseModel
    {
    private:
    ...
    PLAYFABCORE_API void writeDatetime(FDateTime datetime, JsonWriter& writer);
    PLAYFABCORE_API FDateTime readDatetime(const TSharedPtr<FJsonValue>& value);
}
